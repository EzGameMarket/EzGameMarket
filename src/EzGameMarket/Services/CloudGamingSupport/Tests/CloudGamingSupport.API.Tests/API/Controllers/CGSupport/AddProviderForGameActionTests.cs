...
namespace CloudGamingSupport.API.Tests.API.Controllers.CGSupport
{
    public class AddProviderForGameActionTests
    {
        ...
        private AddProviderForGameViewModel CreateModel() => new AddProviderForGameViewModel()
        {
            ProductID = "csgo",
            ProviderID = 2
        };
        ...
        public async void AddProviderForGame_ShouldReturnConflictForR6SId2ProviderIsAddedToR6S()
        {
            ...
            Assert.NotNull(item);
            var expectedProviderID = FakeCGDbContext.Providers[model.ProviderID - 1].ID.GetValueOrDefault();
